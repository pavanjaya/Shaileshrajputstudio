    ...
    <>
      ...
      <section className="mx-auto max-w-2xl px-6 pt-20 pb-16 text-center sm:pt-28">
        ...
        <p className="text-[var(--ink)]/70 leading-relaxed">
          The work is presented the way collectible art is presented globally
          — without prices, on request. Tell us what you&apos;re drawn to,
          and the studio will follow up directly.
        </p>
      </section>
